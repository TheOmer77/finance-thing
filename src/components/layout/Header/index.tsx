...
export const Header = () => (
  <header className='h-64 w-full bg-background bg-gradient-to-b from-primary to-primary/80 text-white lg:h-80 [&+*]:-mt-24 lg:[&+*]:-mt-28 [&>*]:mx-auto [&>*]:w-full [&>*]:max-w-screen-2xl [&>*]:px-4'>
